...
Public Class choixChauffeur
    ...
    Dim mapVertical As Double = 0
    Dim mapHorizontal As Double = 0
    ...
    Public Sub affichePointsMap()
        ...
        Dim mapVerticalActuel As Double = 46.8 + Me.mapVertical
        Dim mapHorizontalActuel As Double = 2.1 + Me.mapHorizontal

        Dim url = New StringBuilder("https://maps.googleapis.com/maps/api/staticmap?center=" & mapVerticalActuel & "," & mapHorizontalActuel & "&zoom=" & zoom & "&size=800x600&maptype=roadmap")

        Dim myConnection = connexionBdd()

        query = "SELECT lieu.lieuId, lieuNom, comId, lieuGps FROM etape, lieu WHERE trnNum=" & listeTournee.SelectedItems.Item(0).Text & " AND etape.lieuId=lieu.lieuId"
        myCommand.Connection = myConnection
        myCommand.CommandText = query
        myReader = myCommand.ExecuteReader
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        Me.mapVertical = Me.mapVertical + 1
        If Me.mapVertical < -90 Then
            Me.mapVertical = Me.mapVertical + 180
        ElseIf Me.mapVertical > 90 Then
            Me.mapVertical = Me.mapVertical - 180
        End If
        affichePointsMap()
    End Sub
    ...
    Private Sub Button2_Click(sender As System.Object, e As System.EventArgs) Handles Button2.Click
        Me.mapHorizontal = Me.mapHorizontal - 1
        If Me.mapHorizontal < -180 Then
            Me.mapHorizontal = Me.mapHorizontal + 360
        ElseIf Me.mapHorizontal > 180 Then
            Me.mapHorizontal = Me.mapHorizontal - 360
        End If
        affichePointsMap()
    End Sub
